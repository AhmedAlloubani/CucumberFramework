...
public class PetStoreSteps {
	...
	public void i_am_able_to_perform_post_request_to_create_a_pet_with_valid_request_body() {
		...
		//another way to access the id of the response
//		int id2 = response.jsonPath().get("id");
//		System.out.println(id);
		...
		//goes to category node first then access what is under it 
		...
		Assert.assertEquals(id, 2003611);
		Assert.assertEquals(response.path("name"), "doggie3");
